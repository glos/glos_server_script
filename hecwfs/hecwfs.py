...
def hecwfs_process(logger, castType, hourMask):
    ...
    os.system("echo 'HECWFS16988|%s|%d-%02d-%02d %02d:00:00|%d-%02d-%02d %02d:00:00|%d-%02d-%02d %02d:%02d:%02d' | nc 192.168.76.104 16988" % (castType.lower(), ymd[0], ymd[1], ymd[2], hour + 1, dt.year, dt.month, dt.day, dt.hour, n.year, n.month, n.day, n.hour, n.minute, n.second))
